      ...
      <article className="Recette">
        ...
        <div className="Etape-Global">
          <div className="Etape">
            <h3>Étape 1 :</h3>
            <p>
              Si besoin, faites décongeler les steaks hachés. Émincez l’échalote
              finement.
            </p>
          </div>
          <div className="Etape">
          ...
          <div className="Etape">
            <h3>Étape 5 :</h3>
            <p>
              Faire revenir les boulettes 5 minutes à la poêle bien chaude avec
          ...
          <div className="Etape">
            <h3>Étape 7 :</h3>
            <p>
              Une fois les pâtes cuites, égouttez-les, puis mélangez-les avec la
              sauce et les boulettes. Servir avec un peu de parmesan (optionnel
              : et de basilic frais si vous en avez) sur le dessus. C'est prêt !
            </p>
          </div>
        </div>
      </article>
